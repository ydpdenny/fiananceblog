...
def post_list(request):
    ...
    return render(request, 'finance/post_list.html', {'posts': posts})

def globalbuster(request):
    return render(request, 'finance/globalbuster.html')


@login_required
def globalbusteractive(request):
    return render(request, 'finance/globalbusteractive.html')
